...
$data[] = array( 
    ...
    "user_level"=>$level,
    "user_actions"=> "
    <a href='index.php?page=report_user_individual&user={$row['user_id']}' class='' data-cat-name='{$row['user_name']}' data-cat-id='{$row['user_id']}'><i data-toggle='tooltip' data-placement='left' title='View this users report' style='font-size: 20px; color:#b5b5b5' class='far fa-eye options'></i></a>"
);
}
