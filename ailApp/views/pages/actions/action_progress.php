                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="form-group ">
                          <select class="form-control" name="status" required>
                            ...
                            <option <?php if($row['action_complete'] == 0){echo "selected";}else{echo "";} ?> value="0">On going</option>
                            <option <?php if($row['action_complete'] == 1){echo "selected";}else{echo "";} ?> value="1">Complete</option>
                          </select>
                    </div>
