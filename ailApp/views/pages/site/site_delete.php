...
<h1 class="h3 mb-4 text-gray-800">Delete Site</h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div id="profile-data" class="card-body">
                    <div class="form-group">
                        ...
                        <b>Site:</b> <?php echo $row['site_name'] ?>
                        
                    </div>

                    
                    <div class="form-group ">
                        <button id="edit_profile1" name="delete_site" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                            <i class="far fa-trash-alt fa-sm text-white-50"></i>&nbsp;&nbsp;Delete Site
                        </button>
                    </div>
